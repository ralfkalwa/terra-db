...
CREATE TABLE IF NOT EXISTS "GEO_BERG" (
	...
	FOREIGN KEY("L_ID","LT_ID") REFERENCES "LANDTEIL"("L_ID","LT_ID"),
...
CREATE TABLE IF NOT EXISTS "HAT_SITZ_IN" (
	...
	"L_ID"	varchar(4) DEFAULT NULL,
	"ABKUERZUNG"	varchar(20) DEFAULT NULL,
	FOREIGN KEY("L_ID","LT_ID","ST_NAME") REFERENCES "STADT"("L_ID","LT_ID","ST_NAME"),
...
CREATE TABLE IF NOT EXISTS "LAND" (
	...
	"HAUPTSTADT"	varchar(25) DEFAULT NULL,
	"LT_ID"	varchar(4) DEFAULT NULL,
	FOREIGN KEY("L_ID","LT_ID","HAUPTSTADT") REFERENCES "STADT"("L_ID","LT_ID","ST_NAME"),
	FOREIGN KEY("L_ID","LT_ID") REFERENCES "LANDTEIL"("L_ID","LT_ID"),
	PRIMARY KEY("L_ID")
);
